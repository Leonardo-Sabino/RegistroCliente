...
public class Second_Reg extends AppCompatActivity {
    ...
    //declaração do array para guardar os nomes
    ...
    public void Registrar(View view) {
        ...
        if (TextUtils.isEmpty(n) || TextUtils.isEmpty(e) || TextUtils.isEmpty(p) || TextUtils.isEmpty(c)) {
            ...
            if (c.length() < 8 || p.length() < 8) {
                ...
                //para verificar se nome ja esta na lista e se estiver mostrará um Toast
                String name = n;
                if (Array_nome.contains(name)) {
                    Toast.makeText(this, "Esse nome já foi adicionado", Toast.LENGTH_SHORT).show();
                }
                //para adicionar o nome no array
                    ...
                    //intent para levar o array para a activity Main
                    Intent intent_array = new Intent(Second_Reg.this,MainActivity.class);
                    //para apresentar o nome na activity Welcome
                    intent.putExtra(nome_message, n);
                    //intent para levar o array
                    intent_array.putExtra("Array_nome",Array_nome);
                }
